...
class DynamicProgramming(Node):
    ...
    def timer_callback(self):
        ...
        # NOTE: Updating the constraint set / solver settings takes awhile for larger state spaces even at 3 dimensions. 
        # This appears to result from the HJR package and interferes with the dynamic programming loop.
        # It would require rewriting part of the HJR package to solve issue - so swift updates to the obstacle set may not be possible.
        ...
        # Alternatively, another node could be made that dynamic programming subscribes to which gets the newest solver settings which contains
